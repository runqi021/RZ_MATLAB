% Ventral_surface_phase_polar_allROI_260602.m
% -----------------------------------------------------------------------
%  ALL-ROI polar overlay, in the spirit of Ventral_surface_coherence_polar_260528,
...
pctP = 100 * histcounts(spk_phi, edgesP) / max(nCyc,eps);
nspk = numel(spk_phi);
end
