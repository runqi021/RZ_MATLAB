...
name = 'C:\Users\zhang\Desktop\DK\251101_vglut_g8s_cy5_live\ROI2_-60_4x\ROI2_-700_200_-60_4x_20lp_00001.tif';
...
figure;
    ...
    ax1 = subplot(312); hold on; plot(shifts_r(:,1),'--k','linewidth',2); title('displacements along x','fontsize',14,'fontweight','bold')
            set(gca,'Xtick',[])
    ax2 = subplot(313); hold on; plot(shifts_r(:,2),'--k','linewidth',2); title('displacements along y','fontsize',14,'fontweight','bold')
