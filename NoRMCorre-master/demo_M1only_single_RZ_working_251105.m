...
name = "C:\Users\zhang\Desktop\DK\251101_vglut_g8s_cy5_live\ROI2_-60_4x\ROI2_-700_200_-60_4x_20lp_00001_darkSub_3sigmaMask.tif";
...
T = size(Y,ndims(Y));
Y = Y - min(Y(:));
%% set parameters (first try out rigid-integer motion correction)

options_rigid = NoRMCorreSetParms('d1',size(Y,1),'d2',size(Y,2),'bin_width',200,'max_shift',15,'us_fac',1,'init_batch',200);
