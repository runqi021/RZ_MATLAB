...
%% ---------------- USER PARAMS ----------------
datasetPath  = "C:\260828_Sert-soma-g8s_vagotomized";
xSign        = +1;
ySign        = +1;
fallback_fps = 30;
...
tossFolders = [ ...
    "D:\260721_Sert_soma_G8s\phys\ro1_2x_x1018y1130_18lp_3000f_00001"
    ...  % "D:\260721_Sert_soma_G8s\phys\...\some_fov_folder"
    ];

% --- pairing / matching ---
maxPairDist_um = 200;    % XY prefilter: only score cross-FOV pairs within this (Inf/[] = all)
maxPairDz_um   = 40;     % ...and within this stage-Z difference (Inf/[] = all)
patchHalf_um   = 30;     % half-size (um) of the patch cut around each centroid = how much
