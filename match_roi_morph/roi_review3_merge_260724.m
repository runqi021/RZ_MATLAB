function roi_review3_merge_260724()
...
maxMergeDist_um = 250;   % only consider merging cells whose centroids are within this
mergeSuggestThr = 0.3;   % only review candidate merges with medoid NCC > this
tileSize = 200;
