...
%% ============================== USER PARAMS ==============================
fovPath       = 'C:\260806_sst-soma-g8s\phys\roi1_3x_z9_14lp_6000f_00001';
roiIdxs       = [7];      % Ca ROIs to display; any count (1, 2, 3, ...).
                           % Tile stack = 1 breath tile + numel(roiIdxs) Ca tiles.

t_start       = 120;             % clip start (s)
t_end         = 150;            % clip end (s)
