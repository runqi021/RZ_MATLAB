...
%
%  ROI list source: coh_cfg -> coherence_polar_data.mat
...
select   = 'sig';        % which ROIs to render: 'sig' | 'active' | 'all'
outDir   = fullfile(rootPath, sprintf('temporal_phase_perROI_%s', select));
