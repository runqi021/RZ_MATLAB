...
%% ========================= PATH SETUP ================================
% This script lives in <repoRoot>/svd_breath_motion/ -- add the repo root so
...
rootPath = 'D:\260721_Sert_soma_G8s\phys';
outDir   = fullfile(rootPath, 'coherence_polar_svd_2600722');
