...
%% ----------------------------- USER PARAMETERS -----------------------------
ROOT_DIR   = 'D:\260721_Sert_soma_G8s\phys';
...
% Two levels below the repo root (analysis_260727\breath_svd). Both chronux and
% orofacial_crop_extract.py live AT the repo root -- the cropper is shared with
% the orofacial analysis, so it deliberately did not move here with this file.
