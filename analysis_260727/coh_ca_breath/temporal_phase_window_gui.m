...
cohData  = cfg.cohData;
outDir   = fullfile(cfg.outRoot, 'representative_traces');   % rendered figures saved here
...
folderPath_manual = '';     % set to ONE recording folder only when selMode='manual'
roi_manual = 9; group_manual = ''; recDate_manual = ''; recName_manual = '';

% --- extra ROIs ALWAYS appended to the list (any selMode) ---
% each row: {folderPath, roi, group, recDate, recName}
% experiment-specific hand-picks; leave empty {} for a general run.
extraROIs = {};
