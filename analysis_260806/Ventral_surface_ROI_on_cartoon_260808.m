% Ventral_surface_ROI_on_cartoon_260808.m  (copy of _260801 + Sst 0806/0807)
% -----------------------------------------------------------------------
...
for sg = 1:numel(scan_dirs)
    ...
    for hh = 1:numel(sam_hits)
        ...
        if any(strcmp(fov, coh_cfg_260727().excludeRecordings))
            nCfgSkip = nCfgSkip + 1;  continue;
        end
...
if USE_STITCH_OFFSETS && nStitched > 0, sfx = [sfx '_stitch260801']; end
